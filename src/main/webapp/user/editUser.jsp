...
<title><bean:message key="button.edit.user" /></title>
<link rel="stylesheet"
...
<body>
	<div class="container col-4">
		...
		<h1 class="text-center">
			<bean:message key="button.edit.user" />
		</h1>

		<html:form styleClass="container" action="/edit-user-post.html"
			...
			<div class="card" style="width: 18rem;">
				...
				<div class="card-body">
					<div class="mb-3">
						...
						<html:file property="file" name="user" accept="image/*" />
					</div>
				</div>
			</div>
